...
.text-highlight-primary {
  background-image: linear-gradient(#0000 66%, #5c60f526 34%);
  background-repeat: repeat-x;
}

.text-highlight-secondary {
  background-image: linear-gradient(#0000 66%, #cfd6df26 34%);
  background-repeat: repeat-x;
}

.text-highlight-tertiary {
  background-image: linear-gradient(#0000 66%, #ff579a26 34%);
  background-repeat: repeat-x;
}

.text-highlight-success {
  background-image: linear-gradient(#0000 66%, #00cc8826 34%);
  background-repeat: repeat-x;
}

.text-highlight-info {
  background-image: linear-gradient(#0000 66%, #00d4ff26 34%);
  background-repeat: repeat-x;
}

.text-highlight-warning {
  background-image: linear-gradient(#0000 66%, #ff8c0026 34%);
  background-repeat: repeat-x;
}

.text-highlight-danger {
  background-image: linear-gradient(#0000 66%, #ff336626 34%);
  background-repeat: repeat-x;
}

.text-highlight-white, .text-highlight-light {
  background-image: linear-gradient(#0000 66%, #ffffff26 34%);
  background-repeat: repeat-x;
}

.text-highlight-dark {
  background-image: linear-gradient(#0000 66%, #16192c26 34%);
  background-repeat: repeat-x;
}
...
.form-control:focus {
  ...
  border-color: #5c60f5;
  outline: 0;
  box-shadow: 0 1px 2px #32324714, 0 0 0 3px #5c60f540;
}
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 3px #5c60f540;
}
...
.accordion {
  ...
  --x-accordion-btn-focus-box-shadow: 0 0 0 3px #5c60f540;
...
.btn {
  ...
  --x-btn-box-shadow: 0 1px 1px #00000013;
...
.btn-primary {
  ...
  --x-btn-active-shadow: 0 0 0 0 #0000;
...
.btn-neutral {
  ...
  --x-btn-active-color: #000;
  --x-btn-active-bg: white;
  --x-btn-active-border-color: #e9ecf2;
  --x-btn-active-shadow: 0 0 0 0 #0000;
  --x-btn-disabled-color: #000;
  --x-btn-disabled-bg: #fff;
...
.dropdown-menu {
  ...
  --x-dropdown-box-shadow: 0px 16px 16px -1px #0a16461a, 0px 0px 1px 0px #0a16460f;
...
.dropdown-menu-dark {
  ...
  --x-dropdown-divider-bg: #f2f3f7;
  --x-dropdown-link-hover-bg: #ffffff26;
  --x-dropdown-link-active-color: theme-color("primary");
  --x-dropdown-link-active-bg: transparent;
  --x-dropdown-link-disabled-color: #8898a9;
...
.modal {
  ...
  --x-modal-box-shadow: 0 .25rem .5rem #0000004d;
...
@media (min-width: 576px) {
  .modal {
    ...
    --x-modal-box-shadow: 0 .5rem 1rem #0000004d;
  }
...
.offcanvas, .offcanvas-xxl, .offcanvas-xl, .offcanvas-lg, .offcanvas-md, .offcanvas-sm {
  ...
  --x-offcanvas-box-shadow: 0 .25rem .5rem #0000004d;
}
...
.navbar {
  ...
  --x-navbar-active-color: #16192c;
  --x-navbar-brand-padding-y: .5rem;
  --x-navbar-brand-margin-end: 0;
  --x-navbar-brand-font-size: 1rem;
  --x-navbar-brand-color: #16192c;
  --x-navbar-brand-hover-color: #16192c;
...
.navbar-dark {
  --x-navbar-color: #ffffffd9;
  --x-navbar-hover-color: #fff;
  --x-navbar-disabled-color: #ffffff40;
...
.navbar-light .navbar-collapse:before {
  border-top-color: #16192c1a;
}

.navbar-light .collapse .nav:before {
  border-color: #16192c1a;
}
...
.navbar-vertical.navbar-light .navbar-nav > .nav-item > .nav-link:hover, .navbar-vertical.navbar-light .navbar-nav > .nav-item > .nav-link.active {
  background-color: #f5f9fc;
}
...
.navbar-vertical.navbar-dark .navbar-nav > .nav-item > .nav-link:hover, .navbar-vertical.navbar-dark .navbar-nav > .nav-item > .nav-link.active {
...
.popover {
  ...
  --x-popover-border-color: #0000000d;
  --x-popover-border-radius: .5rem;
  --x-popover-inner-border-radius: calc(.5rem - 1px);
  --x-popover-box-shadow: 0px .5rem 2rem 0px #0003;
...
.progress {
  ...
  --x-progress-box-shadow: 0 0 0 0 #0000;
  --x-progress-bar-color: #fff;
  --x-progress-bar-bg: theme-color("primary");
...
.progress-circle [class^="display"], .progress-circle .h1, .progress-circle .h2, .progress-circle .h3 {
  color: #16192c;
}
...
.table {
  ...
  --x-table-striped-bg: #0000000d;
  --x-table-active-color: #525f7f;
  --x-table-active-bg: #0000001a;
  --x-table-hover-color: #525f7f;
  --x-table-hover-bg: #00000005;
  width: 100%;
...
.toast {
  ...
  --x-toast-box-shadow: 0px 3px 3px -1px #0a16461a, 0px 0px 1px 0px #0a16460f;
  --x-toast-header-color: #6b7b93;
  --x-toast-header-bg: #ffffffd9;
  --x-toast-header-border-color: #0000000d;
